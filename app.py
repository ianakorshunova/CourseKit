...
TRANSLATIONS = {
    "English": {
        ...
        "add_goal": "Add Goal",
        "goal_title": "Goal",
        "goal_example": "Example: Practice retelling “The Explorers” independently.",
        "goal_course": "Course",
        "no_course": "No course",
        "goal_status": "Status",
        "goal_active": "Active",
        ...
        "set_target_date": "Set a target date",
        "save_goal": "Save Goal",
        "goal_added_successfully": "Goal added successfully.",
        "maximum_active_goals": "You can have up to 3 active goals per student.",
        "select_student_for_goal": "Select student",
        "active_goals": "Active goals",
        "no_goals_yet": "No goals yet.",
        "milestones": "Milestones",
        "milestone": "Milestone",
        "milestone_example": "Example: Review and use the new vocabulary.",

        "goal_title_required": "Please enter a goal.",

        "save_milestone": "Save milestone",

        "no_milestones_yet": "No milestones yet.",

        "change_goal_status": "Status",

        "inactive_goals": "Paused & completed goals",
        "no_inactive_goals": "No paused or completed goals.",

        "confirm_delete_goal": "I confirm that I want to delete this goal.",
        "delete_goal": "Delete goal",

        "edit_goal": "Edit goal",
        "save_goal_changes": "Save changes",
        "goal_updated_successfully": "Goal updated successfully.",

        "delete_milestone": "Delete milestone",
        "confirm_delete_milestone": "I confirm that I want to delete this milestone.",
        "milestone_deleted_successfully": "Milestone deleted successfully.",

        "edit_milestone": "Edit milestone",
        "save_milestone_changes": "Save changes",
        ...
        "active_mistakes": "Active recurring mistakes",
        "add_recurring_mistake": "Add recurring mistake",
        "mistake_text": "Mistake",
        "mistake_example": "Example: Forgets articles before professions.",
        "mistake_note": "Note",
        "mistake_note_example": "Optional: Add context or an example from the lesson.",
        "save_mistake": "Save mistake",
        "mistake_required": "Please enter a recurring mistake.",
        "mistake_added_successfully": "Recurring mistake added successfully.",
        "maximum_active_mistakes": "A student can have up to 5 active recurring mistakes.",
        "no_recurring_mistakes_yet": "No recurring mistakes yet.",
        "mistake_active": "Active",
        "mistake_resolved": "Resolved",

        "mistake_status": "Status",

        "resolved_mistakes": "Resolved mistakes",
        "no_resolved_mistakes": "No resolved mistakes.",

        "edit_mistake": "Edit mistake",
        "save_mistake_changes": "Save changes",
        "mistake_updated_successfully": "Mistake updated successfully.",

        "delete_mistake": "Delete mistake",
        "confirm_delete_mistake": "I confirm that I want to delete this mistake.",
        "mistake_deleted_successfully": "Mistake deleted successfully.",
    ...
    "Русский": {
        ...
        "goal_title": "Цель",
        "goal_example": "Пример: Научиться самостоятельно пересказывать текст «The Explorers».",
        "goal_course": "Курс",
        "no_course": "Без курса",
        "goal_status": "Статус",
        "goal_active": "Активная",
        "goal_completed": "Завершена",
        "goal_paused": "На паузе",
        "target_date": "Целевая дата",
        "set_target_date": "Указать целевую дату",
        "save_goal": "Сохранить цель",
        "goal_added_successfully": "Цель успешно добавлена.",
        "maximum_active_goals": "У одного ученика может быть до 3 активных целей.",
        "select_student_for_goal": "Выберите ученика",
        "active_goals": "Активные цели",
        "no_goals_yet": "Целей пока нет.",
        "milestones": "Этапы",
        "milestone": "Этап",
        "milestone_example": "Пример: Повторить и использовать новую лексику.",

        "goal_title_required": "Введите цель.",

        "save_milestone": "Сохранить этап",

        "no_milestones_yet": "Этапов пока нет.",

        "change_goal_status": "Статус",

        "inactive_goals": "Приостановленные и завершённые цели",
        "no_inactive_goals": "Приостановленных или завершённых целей пока нет.",

        "confirm_delete_goal": "Я подтверждаю удаление этой цели.",
        "delete_goal": "Удалить цель",

        "edit_goal": "Редактировать цель",
        "save_goal_changes": "Сохранить изменения",
        "goal_updated_successfully": "Цель успешно обновлена.",

        "delete_milestone": "Удалить этап",
        "confirm_delete_milestone": "Я подтверждаю удаление этого этапа.",
        "milestone_deleted_successfully": "Этап успешно удалён.",

        "edit_milestone": "Редактировать этап",
        "save_milestone_changes": "Сохранить изменения",
        "milestone_updated_successfully": "Этап успешно обновлён.",

        "dashboard_active_goals": "Активные цели",

        "recurring_mistakes": "Повторяющиеся ошибки",

        "active_mistakes": "Активные повторяющиеся ошибки",
        "add_recurring_mistake": "Добавить повторяющуюся ошибку",
        "mistake_text": "Ошибка",
        "mistake_example": "Пример: Забывает артикли перед названиями профессий.",
        "mistake_note": "Заметка",
        "mistake_note_example": "Необязательно: добавьте контекст или пример с урока.",
        "save_mistake": "Сохранить ошибку",
        "mistake_required": "Введите повторяющуюся ошибку.",
        "mistake_added_successfully": "Повторяющаяся ошибка успешно добавлена.",
        "maximum_active_mistakes": "У ученика может быть до 5 активных повторяющихся ошибок.",
        "no_recurring_mistakes_yet": "Повторяющихся ошибок пока нет.",
        "mistake_active": "Активная",
        "mistake_resolved": "Исправлена",

        "mistake_status": "Статус",

        "resolved_mistakes": "Исправленные ошибки",
        "no_resolved_mistakes": "Исправленных ошибок пока нет.",

        "edit_mistake": "Редактировать ошибку",
        "save_mistake_changes": "Сохранить изменения",
        "mistake_updated_successfully": "Ошибка успешно обновлена.",

        "delete_mistake": "Удалить ошибку",
        "confirm_delete_mistake": "Я подтверждаю удаление этой ошибки.",
        "mistake_deleted_successfully": "Ошибка успешно удалена.",
    },
    ...
    "中文": {
        ...
        "add_goal": "添加目标",
        "goal_title": "目标",
        "goal_example": "示例：能够独立复述《The Explorers》。",
        "goal_course": "课程",
        "no_course": "无课程",
        "goal_status": "状态",
        "goal_active": "进行中",
        ...
        "goal_paused": "已暂停",
        "target_date": "目标日期",
        "set_target_date": "设置目标日期",
        "save_goal": "保存目标",
        "goal_added_successfully": "目标已成功添加。",
        "maximum_active_goals": "每位学生最多可以有 3 个进行中的目标。",
        "select_student_for_goal": "选择学生",
        "active_goals": "进行中的目标",
        "no_goals_yet": "暂无学习目标。",
        "milestones": "阶段目标",
        "milestone": "阶段目标",
        "milestone_example": "示例：复习并使用新词汇。",

        "goal_title_required": "请输入学习目标。",

        "save_milestone": "保存阶段目标",

        "no_milestones_yet": "暂无阶段目标。",

        "change_goal_status": "状态",

        "inactive_goals": "已暂停和已完成的目标",
        "no_inactive_goals": "暂无已暂停或已完成的目标。",

        "confirm_delete_goal": "我确认要删除此目标。",
        "delete_goal": "删除目标",

        "edit_goal": "编辑目标",
        "save_goal_changes": "保存更改",
        "goal_updated_successfully": "目标已成功更新。",

        "delete_milestone": "删除阶段目标",
        "confirm_delete_milestone": "我确认要删除此阶段目标。",
        "milestone_deleted_successfully": "阶段目标已成功删除。",

        "edit_milestone": "编辑阶段目标",
        "save_milestone_changes": "保存更改",
        "milestone_updated_successfully": "阶段目标已成功更新。",

        "dashboard_active_goals": "进行中的目标",

        "recurring_mistakes": "常见错误",

        "active_mistakes": "常见错误",
        "add_recurring_mistake": "添加常见错误",
        "mistake_text": "错误",
        "mistake_example": "示例：在职业名称前经常忘记使用冠词。",
        "mistake_note": "备注",
        "mistake_note_example": "可选：添加课堂中的例子或相关说明。",
        "save_mistake": "保存错误",
        "mistake_required": "请输入常见错误。",
        "mistake_added_successfully": "常见错误已成功添加。",
        "maximum_active_mistakes": "每位学生最多可以有 5 个未解决的常见错误。",
        "no_recurring_mistakes_yet": "暂无常见错误。",
        "mistake_active": "未解决",
        "mistake_resolved": "已解决",

        "mistake_status": "状态",

        "resolved_mistakes": "已解决的错误",
        "no_resolved_mistakes": "暂无已解决的错误。",

        "edit_mistake": "编辑错误",
        "save_mistake_changes": "保存更改",
        "mistake_updated_successfully": "错误已成功更新。",

        "delete_mistake": "删除错误",
        "confirm_delete_mistake": "我确认要删除此错误。",
        "mistake_deleted_successfully": "错误已成功删除。",
    },
}
...
milestones = load_table("milestones")
recurring_mistakes = load_table("recurring_mistakes")
...
if page == "Dashboard":
    ...
    st.subheader(t("dashboard_active_goals"))

    active_goals_dashboard = goals[
        goals["status"] == "active"
    ].copy()

    if active_goals_dashboard.empty:
        st.info(t("no_goals_yet"))
    else:
        dashboard_student_names = dict(
            zip(
                students["id"],
                students["name"],
            )
        ...
        for _, goal_row in active_goals_dashboard.iterrows():
            ...
            total_count = len(goal_milestones)

            student_name = dashboard_student_names.get(
                goal_row["student_id"],
                "",
            )
    ...
    if students.empty:
        ...
        profile_tab, goals_tab, mistakes_tab, progress_tab, skills_tab = st.tabs(
            [
                t("student_profile"),
                t("goals"),
                t("recurring_mistakes"),
                t("progress"),
                t("student_skills"),
            ]
        )
    ...
    lessons_tab, assignments_tab = st.tabs(
            [
                t("lessons"),
                t("assignments"),
            ]
